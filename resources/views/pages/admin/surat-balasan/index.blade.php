                                    ...
                                    <div class="flex flex-wrap items-center gap-2">
                                        <details class="group">
                                            ...
                                            <form method="POST" action="{{ route('admin.surat-balasan.upload', $participant) }}" enctype="multipart/form-data" class="mt-3 w-[19rem] space-y-3 rounded-2xl border border-border bg-white p-4 shadow-xl">
                                                ...
                                                {{-- Pernyataan konfirmasi admin --}}
                                                <label class="flex items-start gap-2 rounded-xl border border-amber-200 bg-amber-50 p-3 text-[11px] font-medium text-navy">
                                                    <input type="checkbox" name="data_verified" value="1" required class="mt-0.5">
                                                    <span>

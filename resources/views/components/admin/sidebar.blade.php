...
$menu = [
    ...
    ['icon' => 'database', 'label' => 'Knowledge Base', 'route' => null],
    ['icon' => 'message-square', 'label' => 'Conversation Logs', 'route' => null],
    ['icon' => 'inbox', 'label' => 'Pertanyaan Tidak Terjawab', 'route' => null],
    ['icon' => 'thumbs-up', 'label' => 'Feedback', 'route' => null],
    ['icon' => 'trending-up', 'label' => 'Analytics', 'route' => null],
    ['icon' => 'settings', 'label' => 'Pengaturan Chatbot', 'route' => null],
    ['icon' => 'users', 'label' => 'Manajemen Admin', 'route' => null],
    ['icon' => 'activity', 'label' => 'Activity Log', 'route' => null],
];
@endphp
    ...
    <nav class="flex-1 space-y-0.5 overflow-y-auto p-3">
        @foreach ($menu as $item)
            @php $active = $item['route'] && request()->routeIs($item['route']); @endphp
                ...
                class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-xs font-medium transition-all {{ $active ? 'bg-ocean/50 text-white' : 'text-blue-300 hover:bg-white/8 hover:text-white' }}"
            >

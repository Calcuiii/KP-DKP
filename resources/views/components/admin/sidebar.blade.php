...
<div
    data-admin-sidebar
    class="flex w-60 flex-shrink-0 flex-col overflow-hidden bg-navy transition-all duration-300"
>
    ...
    <div class="flex items-center gap-2.5 border-b border-white/10 p-4">
        ...
        <div>
            ...
            <div class="text-[10px] leading-tight text-blue-300">
                Jawa Timur
            </div>
        </div>
    ...
    <nav class="flex-1 space-y-0.5 overflow-y-auto p-3">
        ...
        @foreach ($menu as $item)
            ...
            <a
                ...
                class="flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-xs font-medium transition-all
                {{ $active
                    ? 'bg-ocean/50 text-white'
    ...
    <div class="border-t border-white/10 p-3">
        ...
        <form method="POST" action="{{ route('admin.logout') }}">
            ...
            <button
                type="submit"
                class="flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-xs text-blue-300 transition-all hover:bg-white/8 hover:text-red-300"
            >

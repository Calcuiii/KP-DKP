...
function LogoMark({ size = 36, dark = false }: { size?: number; dark?: boolean }) {
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div>
        <div className={`font-bold leading-tight text-sm ${dark ? "text-white" : "text-[#0C2340]"}`}>SI-MELAYUR</div>
...
function LandingPage({ onNavigate }: { onNavigate: (page: Page, q?: string) => void }) {
  ...
  const faqs = [
    { q: "Apa itu SI-MELAYUR?", a: "SI-MELAYUR adalah Sistem Informasi Magang, Penelitian, dan Data Kelautan Jawa Timur milik Dinas Kelautan dan Perikanan Provinsi Jawa Timur. Asisten AI merupakan salah satu fitur di dalam sistem tersebut." },
    { q: "Apakah jawaban chatbot merupakan keputusan resmi Dinas?", a: "Tidak. Jawaban yang diberikan SI-MELAYUR bersifat informatif dan berdasarkan dokumen resmi yang dikelola administrator. Untuk keputusan resmi, silakan hubungi petugas Dinas secara langsung." },
    ...
    { q: "Dari mana chatbot mendapatkan informasi?", a: "SI-MELAYUR menggunakan teknologi Retrieval-Augmented Generation (RAG) yang mencari informasi dari knowledge base berisi dokumen resmi yang telah diverifikasi dan dikelola oleh administrator Dinas." },
    { q: "Apa yang terjadi jika chatbot tidak menemukan jawaban?", a: "Jika tidak ditemukan informasi yang relevan, SI-MELAYUR akan memberitahu Anda dan menyarankan untuk menghubungi petugas Dinas secara langsung. Pertanyaan tersebut juga akan dicatat untuk pembaruan knowledge base." },
          ...
          <div className="relative">
            <div className="rounded-2xl shadow-2xl border border-border bg-white overflow-hidden">
              <div className="px-4 py-3 flex items-center gap-2 border-b border-border" style={{ background: NAVY }}>
                ...
                <div>
                  <div className="text-white text-xs font-semibold">SI-MELAYUR</div>
      ...
      <section className="py-16 bg-[#F4F7FB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold" style={{ color: NAVY }}>Bagaimana SI-MELAYUR Menghasilkan Jawaban?</h2>
          </div>
          ...
          <div className="max-w-2xl mx-auto p-4 rounded-2xl border border-[#1A5FA8]/20 bg-white flex items-start gap-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              SI-MELAYUR hanya memberikan jawaban berdasarkan knowledge base yang telah diverifikasi dan dikelola oleh administrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl p-12 text-center" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, ${OCEAN} 100%)` }}>
            ...
            <p className="text-blue-200 mb-8 max-w-lg mx-auto">Gunakan SI-MELAYUR untuk menemukan informasi berdasarkan dokumen resmi yang tersedia.</p>
            <button
              onClick={() => onNavigate("chat")}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-white">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-semibold" style={{ color: NAVY }}>SI-MELAYUR</div>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6">
          {messages.length === 0 && !typing ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h2 className="text-xl font-bold mb-2" style={{ color: NAVY }}>Halo, ada yang bisa SI-MELAYUR bantu?</h2>
        ...
        <div className="border-t border-border bg-white px-4 py-3">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-[10px] text-muted-foreground text-center mt-2">
              SI-MELAYUR dapat menghasilkan jawaban yang kurang tepat. Pastikan kembali informasi penting melalui layanan resmi.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen flex font-[Inter,sans-serif]" style={{ background: `linear-gradient(135deg, ${NAVY} 0%, ${OCEAN} 100%)` }}>
      <div className="m-auto w-full max-w-sm px-4">
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <p className="text-xs text-center text-muted-foreground mb-6">Panel Manajemen SI-MELAYUR</p>
      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm p-6 max-w-2xl space-y-5">
        {tab === "general" && (
          <>
            ...
            {[
              { label: "Nama Chatbot", val: "SI-MELAYUR" },
            ...
            <div>
              ...
              <textarea defaultValue="Halo! Saya SI-MELAYUR. Ada yang bisa saya bantu seputar Kerja Praktik dan Magang?" className="w-full px-3 py-2.5 rounded-xl border border-border bg-input-background text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary/20" rows={3} />
            </div>
